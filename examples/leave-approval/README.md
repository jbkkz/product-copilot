...
Steps 3 and 4 are two views of step 2. Any other artifact (user stories, an estimate) comes from the
same `model.json` — that's the point: the model is the product, everything else is a render of it.
