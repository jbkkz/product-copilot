...
def main() -> None:
    ...
    if from_path:
        ...
        print('Usage: python src/engine.py [--once] [--stories] [--estimate] [--prd] [--criteria] "request" | file.md')
        print('       python src/engine.py --from out/<slug>/model.json [--stories] [--estimate] [--prd] [--criteria]')
        sys.exit(1)
